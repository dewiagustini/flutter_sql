...
class AddUserDialog {
    ...
    return new AlertDialog(
      ...
      content: new SingleChildScrollView(
        child: new Column(
          ...
          children: <Widget>[
            getTextField("Masukan nama depan", teFirstName),
            getTextField("Masukan nama belakang", teLastFirstName),
            getTextField("DD-MM-YYYY", teDOB),
            getTextField("Masukan umur", teUmur),
            getTextField("Masukan email", teEmail),
            new GestureDetector(
              onTap: () {
                addRecord(isEdit);
  ...
  Future addRecord(bool isEdit) async {
    ...
    var user = new User(teFirstName.text, teLastFirstName.text, teDOB.text, teUmur.text, teEmail.text);
    if (isEdit) {
